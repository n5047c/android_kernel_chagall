...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp", 1, 1, KHZ,   102000, 294000, 342000, 427000, 475000,  500000,  500000,  500000,  500000),
	CORE_DVFS("cpu_lp", 2, 1, KHZ,   102000, 295000, 370000, 428000, 475000,  513000,  579000,  620000,  620000),
	...
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),

	CORE_DVFS("vde",    1, 1, KHZ,   200000, 228000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("mpe",    1, 1, KHZ,   200000, 234000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("2d",     1, 1, KHZ,   200000, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("epp",    1, 1, KHZ,   200000, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("3d",     1, 1, KHZ,   200000, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("3d2",    1, 1, KHZ,   200000, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("se",     1, 1, KHZ,   200000, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),

	CORE_DVFS("vde",    2, 1, KHZ,   200000, 228000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("mpe",    2, 1, KHZ,   200000, 234000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("2d",     2, 1, KHZ,   200000, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("epp",    2, 1, KHZ,   200000, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("3d",     2, 1, KHZ,   200000, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("3d2",    2, 1, KHZ,   200000, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("se",     2, 1, KHZ,   200000, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),

	CORE_DVFS("vde",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  600000,  600000,  600000),
	CORE_DVFS("mpe",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  600000,  600000,  600000),
	CORE_DVFS("2d",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  600000,  600000,  600000),
	CORE_DVFS("epp",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  600000,  600000,  600000),
	CORE_DVFS("3d",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  600000,  600000,  600000),
	CORE_DVFS("3d2",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  600000,  600000,  600000),
	...
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("cbus",   1, 1, KHZ,   200000, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("cbus",   2, 1, KHZ,   200000, 267000, 380000, 492000, 528000,  564000,  600000,  600000,  600000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1,      1,      1,      1,      1,       1,  600000,  600000,  600000),
	...
	CORE_DVFS("sbc1",  -1, 1, KHZ,    48000,  48000,  48000,  48000,  52000,  52000,   52000,    52000,   52000),
	CORE_DVFS("sbc2",  -1, 1, KHZ,    48000,  48000,  48000,  48000,  52000,  52000,   52000,    52000,   52000),
	CORE_DVFS("sbc3",  -1, 1, KHZ,    48000,  48000,  48000,  48000,  52000,  52000,   52000,    52000,   52000),
	CORE_DVFS("sbc4",  -1, 1, KHZ,    48000,  48000,  48000,  48000,  52000,  52000,   52000,    52000,   52000),
	CORE_DVFS("sbc5",  -1, 1, KHZ,    48000,  48000,  48000,  48000,  52000,  52000,   52000,    52000,   52000),
	CORE_DVFS("sbc6",  -1, 1, KHZ,    48000,  48000,  48000,  48000,  52000,  52000,   52000,    52000,   52000),
