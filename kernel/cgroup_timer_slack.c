...
static struct cgroup_subsys_state *tslack_create(struct cgroup_subsys *ss, struct cgroup *cgroup)
{
...
static void tslack_destroy(struct cgroup_subsys *ss, struct cgroup *cgroup)
{
